...
@app.route('/restaurant/user/JSON')
def restaurantsUserJSON():
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if (login_session['user_id'] == creator.id):
            if request.method == 'POST':
                ...
                return redirect(url_for('showMenu', restaurant_id=restaurant_id,creator=creator))
            else:
                return render_template('editmenuitem.html', restaurant_id=restaurant_id, menu_id=menu_id, item=editedItem,creator=creator)
    else: 
        return redirect(url_for('showRestaurants'))
